...
function Header({ user, onViewChange, onLogout }) {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [
					...
					" さん",
					user.isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						style: {
							color: "gold",
							fontWeight: "bold",
							backgroundColor: "#333",
...
//#endregion
//#region src/views/ThreadListPage.tsx
function ThreadListPage({ threads, newTitle, setNewTitle, handleCreateThread, sortBy, handleSortChange, handleRefreshThreads, handleSelectThread, handleDeleteThread, currentPage, totalPages, fetchThreadsList, user }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			threads.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				style: { color: "gray" },
				children: "現在スレッドはありません。新しく作成してください。"
				...
				children: threads.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
							...
							children: t.title
						}), (user.isAdmin || user.id === t.user_id) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
//#endregion
//#region src/views/ThreadDetailPage.tsx
function ThreadDetailPage({ activeThread, onBackToConversations, posts, handleCreatePost, handleDeletePost, user }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: posts.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					style: { color: "gray" },
					children: "まだコメントがありません。最初のコメントをどうぞ！"
				}) : posts.map((p, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					style: {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", {
								...
								children: [
									index + 1,
									": ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: p.username || "退会済ユーザー" }),
									" (",
									new Date(p.created_at).toLocaleString(),
									")"
								]
							}), (user.isAdmin || user.id === p.user_id) && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
					...
					children: ["📷 画像を添付する", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
						type: "file",
						accept: "image/*",
						ref: fileInputRef,
				...
				}), selectedImage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					style: {
						marginLeft: "10px",
						fontSize: "13px",
						color: "#666"
...
var API_BASE = "https://jroom.top";
/**
* 汎用的なカスタムFetch関数。環境に合わせて自動的にAPIのベースURLを結合します。
*/
var customFetch = async (path, options) => {
	return fetch(`${API_BASE}${path}`, options);
};
//#endregion
//#region src/views/MyPage.tsx
var MyPage = ({ user, editDisplayName, setEditDisplayName, handleUpdateDisplayName, onBackToThreadList }) => {
	const [currentPassword, setCurrentPassword] = (0, import_react.useState)("");
	const [newPassword, setNewPassword] = (0, import_react.useState)("");
	const [confirmPassword, setConfirmPassword] = (0, import_react.useState)("");
	const [passwordMessage, setPasswordMessage] = (0, import_react.useState)(null);
	...
	const handleUpdatePassword = async (e) => {
		...
		try {
			...
			if (!response.ok) throw new Error(result.error || "パスワードの変更に失敗しました。");
			setPasswordMessage({
				type: "success",
				text: result.message || "パスワードが正常に変更されました。"
			});
			setCurrentPassword("");
			setNewPassword("");
			setConfirmPassword("");
			...
			setPasswordMessage({
				type: "error",
				text: err.message || "予期せぬエラーが発生しました。"
			});
		} finally {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "現在のハンドル名:" }),
							" ",
							user.username
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "メールアドレス:" }),
							" ",
							user.email
						] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "アカウント権限:" }),
							" ",
							user.isAdmin ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								style: {
									color: "red",
								...
								children: "管理者"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "一般ユーザー" })
						] })
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("hr", { style: {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "✏ ハンドル名の変更" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "🔒 パスワードの変更" }),
				passwordMessage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					style: {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: isSubmitting ? "変更を処理中..." : "パスワードを更新"
						})
					]
				})
			]
...
//#endregion
//#region src/views/LoginPage.tsx
function LoginPage({ onLoginSuccess }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			view === "login" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					border: "1px solid #ddd",
					padding: "25px",
					borderRadius: "8px",
...
function App() {
	...
	const [editDisplayName, setEditDisplayName] = (0, import_react.useState)("");
	const [user, setUser] = (0, import_react.useState)(null);
	const [sortBy, setSortBy] = (0, import_react.useState)("thread_new");
	(0, import_react.useEffect)(() => {
		const token = localStorage.getItem("token");
		if (token) {
			const fetchCurrentUser = async () => {
				try {
					const response = await customFetch("/api/me", { headers: { "Authorization": `Bearer ${token}` } });
	...
	const fetchThreadsList = async (page = 1, passedToken, sortOption) => {
		const token = passedToken || localStorage.getItem("token");
		const currentSort = sortOption || sortBy;
		try {
			const response = await customFetch(`/api/threads?page=${page}&sort=${currentSort}`, { headers: { "Authorization": `Bearer ${token}` } });
			const data = await response.json();
	...
	const handleRefreshThreads = () => {
		fetchThreadsList(currentPage, void 0, sortBy);
	};
	const handleSortChange = (newSort) => {
		setSortBy(newSort);
		fetchThreadsList(1, void 0, newSort);
	};
	const handleCreateThread = async (e) => {
		...
		try {
			...
			if (!response.ok) throw new Error(data.error);
			setNewTitle("");
			setSortBy("thread_new");
			fetchThreadsList(1, void 0, "thread_new");
		} catch (err) {
	...
	const fetchPosts = async (threadId) => {
		const token = localStorage.getItem("token");
		try {
			const response = await customFetch(`/api/threads/${threadId}/posts`, { headers: { "Authorization": `Bearer ${token}` } });
			const data = await response.json();
			if (!response.ok) throw new Error(data.error);
			setPosts(data);
		} catch (err) {
	...
	if (view === "mypage" && user) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MyPage, {
		user,
		editDisplayName,
		setEditDisplayName,
	...
	if (view === "threadlist" && user) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: {
			fontFamily: "sans-serif",
			backgroundColor: "#fff",
			minHeight: "100vh"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
		...
		}), activeThread ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThreadDetailPage, {
			activeThread,
			...
			handleDeletePost,
			user
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThreadListPage, {
			threads,
			newTitle,
			setNewTitle,
			handleCreateThread,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoginPage, { onLoginSuccess: handleLoginSuccess });
}
//#endregion
//#region src/main.tsx
...
//# sourceMappingURL=index-BKO1R10o.js.map